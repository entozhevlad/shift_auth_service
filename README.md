...
```
cd existing_repo
git remote add origin https://hub.mos.ru/shift-python/y2024/homeworks/vzarubin/shift_auth_service.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/shift-python/y2024/homeworks/vzarubin/shift_auth_service/-/settings/integrations)
